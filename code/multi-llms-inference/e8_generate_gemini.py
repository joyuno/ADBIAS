...
OUTPUT_JSON_PATH = './results/output_e8_results_gemini.json'
...
OPENROUTER_API_KEY = '당신의 키를 넣으시오!!' # 내꺼 key
...
First, write a justification for each trait: Ideas, Organization, Voice, Word choice, Sentence fluency, and Conventions.
