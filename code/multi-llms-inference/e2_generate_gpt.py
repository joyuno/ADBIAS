...
OUTPUT_JSON_PATH = './results/output_e2_results_gpt.json'
...
First, write a justification for each trait: Ideas, Organization, Word choice, Sentence fluency, and Conventions.
