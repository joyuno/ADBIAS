...
RUBRICS_PATH = './data/rubrics/rubrics.txt'
PROMPT_PATH = './data/rubrics/prompt.txt'
OUTPUT_JSON_PATH = './results/output_results_gemini.json'
...
# LLM_MODEL = "openai/gpt-4o"  ####### 여기에 OpenRouter 모델 Path 
LLM_MODEL = "google/gemini-2.5-flash-preview"  ####### 여기에 OpenRouter 모델 Path 
...
First, write a justification for each trait: Ideas, Organization, Style, and Conventions.
