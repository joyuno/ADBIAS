...
ESSAY_FILE_PATH = './data/asap_data/asap_5.csv'
RUBRICS_PATH = './data/rubrics/5_rubrics.txt'
PROMPT_PATH = './data/rubrics/5_prompt.txt'
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_5.csv'
SEVERITY_PATH = './data/ranking/ranking/set_5_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e5_peer_result.json'
ERROR_IDS_PATH = './results/peer_results/e5_error_ids.txt'
...
def build_system_prompt(rubric_content):
    return f"""
You are a rater for essays written by students from grades 8.
...
1. Write a justification for each trait: Content, Prompt adherence, Language, and Narrativity.
2. Assign a score from 0 to 4 for each trait.

Notes: Remember that these essays are written by grade 8 students.
Avoid interpreting the rubric too strictly; consider what is developmentally appropriate for grade 8 students.
