...
ESSAY_FILE_PATH = './data/asap_data/asap_3.csv'
RUBRICS_PATH = './data/rubrics/3_rubrics.txt'
PROMPT_PATH = './data/rubrics/3_prompt.txt'
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_3.csv'
SEVERITY_PATH = './data/ranking/ranking/set_3_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e3_peer_result.json'
ERROR_IDS_PATH = './results/peer_results/e3_error_ids.txt'
