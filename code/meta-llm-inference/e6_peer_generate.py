...
ESSAY_FILE_PATH = './data/asap_data/asap_6.csv'
RUBRICS_PATH = './data/rubrics/6_rubrics.txt'
PROMPT_PATH = './data/rubrics/6_prompt.txt'
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_6.csv'
SEVERITY_PATH = './data/ranking/ranking/set_6_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e6_peer_result.json'
ERROR_IDS_PATH = './results/peer_results/e6_error_ids.txt'
