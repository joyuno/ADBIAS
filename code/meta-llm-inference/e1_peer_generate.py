...
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_1.csv'
SEVERITY_PATH = './data/ranking/ranking/set_1_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e1_peer_result14.json'
ERROR_IDS_PATH = './results/peer_results/e1_error_ids.txt'
