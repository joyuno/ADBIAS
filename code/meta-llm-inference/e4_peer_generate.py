...
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_4.csv'
SEVERITY_PATH = './data/ranking/ranking/set_4_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e4_peer_result.json'
ERROR_IDS_PATH = './results/peer_results/e4_error_ids.txt'
