...
ESSAY_FILE_PATH = './data/asap_data/asap_8.csv'
RUBRICS_PATH = './data/rubrics/8_rubrics.txt'
PROMPT_PATH = './data/rubrics/8_prompt.txt'
PEER_REVIEWS_PATH = './data/peer_data/csv_data/essay_scores_set_8.csv'
SEVERITY_PATH = './data/ranking/ranking/set_8_ranking.txt'
OUTPUT_JSON_PATH = './results/peer_results/output_e8_peer_result.json'
ERROR_IDS_PATH = './results/peer_results/e8_error_ids.txt'
...
{{
  ...
  "scores": {{
    ...
    "voice": {{"rationale": "Your rationale here.", "score": 0}},
...
1. Write a justification for each trait: Ideas, Organization, Voice, Word choice, Sentence fluency, and Conventions.
...
def evaluate_essay_openrouter(essay_id, essay_set, essay_text, prompt_text, rubric_content, peer_df, severity):
    ...
    try:
        ...
        return {
            "essay_id": essay_id,
            "essay_set": essay_set,
            "scores": {trait: {"score": 0, "rationale": f"Error: {e}"} for trait in ['ideas', 'organization', 'voice', 'word choice', 'sentence fluency', 'conventions']}
        }
